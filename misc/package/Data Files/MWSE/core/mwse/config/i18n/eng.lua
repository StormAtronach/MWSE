return {
	...
	["useCollisionRootOnlyUpdates.label"] = "Enable root-only collision volume updates",
	["useCollisionRootOnlyUpdates.description"] = "If enabled, per-frame collision volume updates for actors refresh the root volume directly instead of walking the actor's entire scene graph, when the actor is known to carry no deeper collision volumes. This reduces collision update cost with many actors around.",
