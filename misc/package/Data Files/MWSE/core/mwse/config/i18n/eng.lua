return {
	...
	["usePhysicsOptimizations.label"] = "Enable physics optimizations",
	["usePhysicsOptimizations.description"] = "If enabled, raytests and swept collision tests against complex meshes are accelerated with cached bounding volume hierarchies instead of testing every triangle, and redundant per-frame collision volume updates are skipped. This substantially reduces the cost of activation, sun glare, line of sight, tes3.rayTest queries, and actor movement collision. Results are identical to vanilla behavior, only faster; disable to restore vanilla physics.",
